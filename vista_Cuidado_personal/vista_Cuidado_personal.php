...
{  
    ...
    public function __construct()
    {
        ...
        $this->db = $db;
        echo '<link rel="stylesheet" type="text/css" href="estilo_crud_cuidado.css">';
    }
        public function listar ()
    {
        echo "<table border='2'>";  
        echo "<caption>  <div class='titulo-container'> CUIDADO PERSONAL
        </div></caption>";
