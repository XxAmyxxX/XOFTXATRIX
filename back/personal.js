...
app.get('/productos/personal', (req, res) => {
...
app.get('/productos/personal/:id_producto', (req, res) => {
...
app.post('/productos/personal/agregar', (req, res) => {
...
app.put('/productos/actualizar/personal/:id_producto', (req, res) => {
...
app.delete('/productos/borrar/personal/:id', (req, res) => {
    const { id } = req.params
