...
app.get('/productos/mamas', (req, res) => {
...
app.get('/productos/mamas/:id', (req, res) => {
    const { id } = req.params
...
app.post('/productos/mom/agregar', (req, res) => {
...
app.put('/productos/actualizar/mom/:id_producto', (req, res) => {
...
app.delete('/producto/borrar/mom/:id_producto', (req, res) => {
