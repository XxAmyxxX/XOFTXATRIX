...
{  
    ...
    public function __construct()
    {
        ...
        $this->db = $db;
        echo '<link rel="stylesheet" type="text/css" href="estilo_crud_belleza.css">';
    }
    public function listar ()
    {
        echo "<table border='2'>";  
        echo "<caption>  <div class='titulo-container'> BELLEZA
        </div></caption>";
...
$sql2 = "SELECT * FROM categorias WHERE id_Categoria='2'";
